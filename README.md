...
This repository provides the **dataset, and code** for the study.
The work delivers high-resolution (≈500 m) maps of Mean Higher High Water (MHHW) and Great Diurnal Range (GT) at 89 115 coastal CORA nodes.
